...
class Authentication: XCTestCase, ServerNetworkingAuthentication {
    // These values need to be refreshed before running these tests.
    static let accessToken = "ya29.Ci_AAzh0S30zlc2eItulEK7Lo4Sh2VRhj6Fn8pQithb08-Do79eOnUZWWf4A_VoSlQ"
    ...
    override func setUp() {
        ...
        self.authTokens = [
            ...
            ServerConstants.GoogleHTTPAccessTokenKey: Authentication.accessToken
        ]
