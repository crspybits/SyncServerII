...
begin 
   ...
   START TRANSACTION;
		...
		ALTER TABLE SharingInvitation ADD COLUMN allowSocialAcceptance BOOL NOT NULL DEFAULT TRUE;
      ALTER TABLE SharingInvitation ADD COLUMN numberAcceptors INT UNSIGNED NOT NULL DEFAULT 1;
