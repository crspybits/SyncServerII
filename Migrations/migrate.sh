...
# e.g., ./Migrations/migrate.sh ~/Desktop/Apps/SyncServerII/Private/Server/SharedImages-local.json Migrations/9.sql localhost
# e.g., ./Migrations/migrate.sh ~/Desktop/Apps/SyncServerII/Private/Server.json.aws.app.bundles/Neebla-production.json Migrations/9.sql
