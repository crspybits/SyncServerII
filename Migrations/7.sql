...
begin 
   ...
   START TRANSACTION;
		...
		-- Remove fileSizeBytes from Upload, FileIndex
		ALTER TABLE Upload DROP COLUMN fileSizeBytes;
		ALTER TABLE FileIndex DROP COLUMN fileSizeBytes;
		
		-- Replace with lastUploadedChecksum.
		ALTER TABLE Upload ADD COLUMN lastUploadedCheckSum TEXT;
		ALTER TABLE FileIndex ADD COLUMN lastUploadedCheckSum TEXT;
