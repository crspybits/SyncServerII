...
let package = Package(
    ...
    dependencies: [
        ...
        .Package(url: "https://github.com/crspybits/Kitura-Credentials.git", majorVersion: 1, minor: 4),
        ...
        .Package(url: "https://github.com/crspybits/Kitura-CredentialsGoogle.git", majorVersion: 1, minor: 4),
