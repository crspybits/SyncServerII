...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/crspybits/SyncServer-Shared.git", .upToNextMinor(from: "6.1.0")),
        ...
        //.package(url:"https://github.com/hkellaway/Gloss.git", .upToNextMinor(from: "2.0.0")),
